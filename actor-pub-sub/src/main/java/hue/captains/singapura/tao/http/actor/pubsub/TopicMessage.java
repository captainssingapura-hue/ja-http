...
public sealed interface TopicMessage<M extends Message>
    ...
    record Subscribe<M extends Message>(ActorRef subscriber) implements TopicMessage<M> {}

    /** Ask the topic actor to stop delivering publications to {@code subscriber}. */
    record Unsubscribe<M extends Message>(ActorRef subscriber) implements TopicMessage<M> {}
